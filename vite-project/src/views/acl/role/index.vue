<template>
  ...
  <el-card style="margin: 10px 0px">
    <el-button icon="Plus" size="default" type="primary" @click="addRole">
      添加职位
    </el-button>
  ...
  >
    ...
    <template #footer>
      <el-button size="default" type="primary" @click="dialogVisite = false">
        取消
      </el-button>
      <el-button size="default" type="primary" @click="save">确定</el-button>
    </template>
  </el-dialog>
